...
/**
 * Calculate SMS Size for Argentina OB. <p />
 * obId: 722070<p/>
 ...
 *
 */
public class OB_Argentina extends OBSizeCalculator {
	 ...
	 */
	public OB_Argentina(int gsm7NumChars, int ucs2NumChars) {
	...
	public void calculateSize(String message) throws SMSSizeException {
		...
		// Argentina: SMS-MT must be limited to 160 characters only if all chars are GSM7. 
