...
/**
 * Calculate SMS Size for Chile OB.<p />
 * obId: 73007<p/>
 ...
 *
 */
public class OB_Chile extends OBSizeCalculator {

	/**
	 * Default constructor.
	 * @param maxChars Maximum 
	 */
	public OB_Chile(int maxChars) {
	...
	public void calculateSize(String message) throws SMSSizeException {
		...
		// Chile: SMS-MT must be limited to 140 characters.
