...
@XmlType(name = "ClientExceptionType", namespace = "http://www.telefonica.com/schemas/UNICA/REST/common/v1", propOrder = {
    "exceptionCategory",
    "exceptionId",
    "text",
    "variables"
...
public class ClientExceptionType {
    ...
    @XmlElement(namespace = "http://www.telefonica.com/schemas/UNICA/REST/common/v1", required = true)
