 ...
 *
 */
public class JAXBTransactionStorageExtensionv2_1RestContextSingleton {
	...
	public static JAXBContext getJAXBContext() throws JAXBException
	{
		if (context==null)
		{
			context = JAXBContext.newInstance("com.telefonica.schemas.unica.rest.transactionstorage.extensions.v2_1");
		}
		return context;
	}
}
