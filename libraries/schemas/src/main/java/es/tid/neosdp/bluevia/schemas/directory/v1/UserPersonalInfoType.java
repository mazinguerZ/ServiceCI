...
@XmlType(name = "UserPersonalInfoType", namespace = "http://www.telefonica.com/schemas/UNICA/REST/directory/v1/", propOrder = {
    "displayName",
    "name",
    "namePrefix",
    "nameSufix",
...
public class UserPersonalInfoType {
    ...
    public void setName(JAXBElement<NameType> value) {
        this.name = ((JAXBElement<NameType> ) value);
    }
    ...
    public void setNamePrefix(JAXBElement<String> value) {
        this.namePrefix = ((JAXBElement<String> ) value);
    }
    ...
    public void setNameSufix(JAXBElement<String> value) {
        this.nameSufix = ((JAXBElement<String> ) value);
    }
    ...
    public void setGender(JAXBElement<GenderType> value) {
        this.gender = ((JAXBElement<GenderType> ) value);
    }
