 ...
 * generated in the com.telefonica.schemas.unica.rest.bablepayment.v1 package. 
...
public class ObjectFactory {
    ...
    private final static QName _PaymentTransactionList_QNAME = new QName("http://www.telefonica.com/schemas/UNICA/REST/bablePayment/v1/", "paymentTransactionList");
    private final static QName _AmountTransaction_QNAME = new QName("http://www.telefonica.com/schemas/UNICA/REST/bablePayment/v1/", "amountTransaction");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.telefonica.schemas.unica.rest.bablepayment.v1
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.telefonica.com/schemas/UNICA/REST/bablePayment/v1/", name = "paymentTransactionList")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.telefonica.com/schemas/UNICA/REST/bablePayment/v1/", name = "amountTransaction")
